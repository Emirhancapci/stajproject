...
<main class="main__content_wrapper">
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="hero__slider2--items hero__slider--bg2 slider1">
                                    <div class="hero__slider2--items__inner">
                                        <div class="slider__content2 text-center">
                                            <p class="slider__content2--desc desc1 text-white mb-15">Tüm İhtiyaçlarınız İçin  </p>
                                            <h2 class="slider__content2--maintitle text-white h1"> Türkiye'nin En Büyük  <br>
                                                Online Alışveriş Sitesi</h2>
                                            <a class="slider__content2--btn primary__btn" href="{{ url('/website#products') }}" rel="nofollow">Alışverişe Başla</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 banner2__col--3">
                    <h3 style="color: red" class="banner__content--style2__subtitle">Sınırlı Sayıda</h3>
                    <h2 class="banner__content--style2--title">Iphone 14 Pro Max </h2>
                    <div class="banner__sidebar--two banner__items banner__sidebar2">
                        <a class="banner__items--thumbnail position__relative" href="{{ URL::to('website/product-detail/iphone-14-pro-max') }}"><img class="{{ asset('frontend/img/banner/iphonephoto.jpg') }}" src="{{ asset('frontend/img/banner/iphonephoto.jpg') }}" alt="banner-img">
            ...
            <div class="shipping__style2--inner border-radius-10 d-flex justify-content-between">
                <div class="shipping__style2--items d-flex align-items-center">
                    ...
                    <div class="shipping__style2--content">
                        <h2 class="shipping__style2--content__title">GÜVENLİ ALIŞVERİŞ</h2>
                        <p class="shipping__style2--content__desc">ADAS</p>
                    </div>
                </div>
                <div class="shipping__style2--items d-flex align-items-center">
                    <div class="shipping__style2--icon">
                    ...
                    <div class="shipping__style2--content">
                        <h2 class="shipping__style2--content__title">HIZLI KARGO</h2>
                        <p class="shipping__style2--content__desc"></p>
                    </div>
                </div>
                <div class="shipping__style2--items d-flex align-items-center">
                    <div class="shipping__style2--icon">
                    ...
                    <div class="shipping__style2--content">
                        <h2 class="shipping__style2--content__title">30 GÜN GARANTİ</h2>
                        <p class="shipping__style2--content__desc"></p>
                    </div>
                </div>
                <div class="shipping__style2--items d-flex align-items-center">
                    ...
                    <div class="shipping__style2--content">
                        <h2 class="shipping__style2--content__title">7/24 DESTEK</h2>
   ...
   <!-- Start banner section -->
    ...
    <section id="products" class="product__section section--padding color-scheme-2 pt-0">
        <div class="container">
            <div class="product__section--header d-flex justify-content-between mb-40">

                <div class="section__heading text-center">
                    <h2 class="section__heading--maintitle">Ürünler</h2>
                </div>
                <ul class="product__tab--btn style2 d-flex justify-content-center">
                    @foreach (getCategoriesByLimit() as $category)
                        <li class="product__tab--btn__list style2 active" data-toggle="tab" data-target="#{{ $category->name }}">{{ $category->name }}</li>
                    @endforeach
                </ul>
            </div>
            <div class="tab_content">
                @foreach (getCategoriesByLimit() as $index => $category)
                <div id="{{ $category->name }}" class="tab_pane {{ $index == 0 ? 'active show' : '' }}">
                                ...
                                <div class="col mb-30">
                                    <form action="{{ route('addToCart') }}" method="POST">
                                        ...
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="{{ route('website.product.detail', $product->slug) }}">
                                                <img class="product__items--img product__primary--img" src="{{ $product->image }}" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--content text-center">
                                            <div class="product__items--color"></div>
                                            <a class="product__items--content__tag" href="{{ route('website.product.detail', $product->slug) }}">{{ $category->name }}</a>
                                            <h3 class="product__items--content__title h4"><a href="{{ route('website.product.detail', $product->slug) }}">{{ $product->name }}</a></h3>
                                            ...
                                            @if(Auth()->check())
                                            <button class="product__items--action__cart--btn primary__btn btn__style2" href="cart.html">
