...
<!-- Mirrored from risingtheme.com/html/demo-furea/furea/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 13:51:43 GMT -->
<head>
  <meta charset="utf-8">
  <title>Emirhan - E-ticaret Sitesi</title>
...
@include('frontend.layouts.footer')
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend/img/product/big-product1.webp') }}"><img class="product__media--preview__items--img" src="assets/img/product/big-product1.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend/img/product/big-product1.webp') }}" data-gallery="product-media-preview">
        ...
        <div class="newsletter__popup--inner">
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block" src="{{ asset('frontend/img/banner/newsletter-popup-thumb2.png') }}" alt="newsletter-popup-thumb">
                </div>
    ...
    <!-- Scroll top bar -->
    <button class="color-scheme-2" aria-label="scroll top btn" id="scroll__top"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M112 244l144-144 144 144M256 120v292"/></svg></button>
...
<!-- Mirrored from risingtheme.com/html/demo-furea/furea/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 13:52:08 GMT -->
</html>
