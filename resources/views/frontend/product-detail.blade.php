        ...
        <div class="row row-cols-1">
            <div class="col">
                <div class="breadcrumb__content">
                    <h1 class="breadcrumb__content--title text-white mb-10">Ürün Detayları</h1>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__media--preview__items">
                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href=""><img class="{{ asset($product->image) }}" src="{{ asset($product->image) }}" alt="product-media-img"></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__media--preview__items">
                    ...
                    <form id="addToCartForm" action="{{ route('addToCart') }}" method="POST">
                        ...
                        <div class="product__variant">
                            <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                <button style="margin-left: 10px" class="quickview__cart--btn primary__btn" type="submit">Sepete Ekle</button>
                            </div>
                        </form>
                        </div>
                        ...
                        <div class="guarantee__safe--checkout">
                            <h5 class="guarantee__safe--checkout__title">Ödeme Yöntemleri</h5>
                            <img class="guarantee__safe--checkout__img" src="{{ asset('frontend/img/other/safe-checkout.webp') }}" alt="Payment Image">
                        </div>
