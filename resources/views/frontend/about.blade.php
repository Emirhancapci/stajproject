                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about__thumbnail d-flex">
                            <div class="about__thumbnail--items">
                                <img class="about__thumbnail--img border-radius-5 display-block" src="{{ asset('frontend/img/banner/about1.jpg') }}" alt="about-thumbnail">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            <span class="about__content--subtitle text__secondary mb-20"> BİZ KİMİZ</span>
                            <h2 class="about__content--maintitle mb-25">Modern çağın en popüler <br> e-commerce alışveriş platformuyuz.</h2>
                            <p class="about__content--desc mb-20">Müşterilerimize en iyi alışveriş deneyimini sunmak için çabalıyoruz ve Türkiye'nin önde gelen online perakendecileriyle işbirliği yaparak geniş bir ürün yelpazesi sunuyoruz.</p>
                            <p class="about__content--desc mb-25">Vizyonumuz, müşterilerimize aradıkları ürünleri en kolay ve hızlı şekilde ulaştırmak, aynı zamanda trendleri takip ederek onlara ilham vermektir. Herkesin ihtiyaçlarına uygun ürünleri bulabileceği geniş bir platform olmayı hedefliyoruz.</p>
                            <div class="about__author position__relative">
                                <h4 class="about__author--name">Emirhan Çapcı</h4>
                                <span class="about__author--rank">Kurucu ve CEO</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="team__section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-30">
                    <h2 class="section__heading--maintitle">Ekibimiz</h2>
                </div>
                <div class="team__container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block" src="{{ asset('frontend/img/other/team3.webp') }}" alt="team-thumb">
                                </div>
                                <div class="team__content ">
                                    <h3 class="team__content--title">Emirhan Çapcı</h3>
                                    <span class="team__content--subtitle">CEO - Kurucu</span>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumbnail">
                                    <img class="team__thumbnail--img border-radius-50 display-block" src="{{ asset('frontend/img/other/team1.webp') }}" alt="team-thumb">
                                </div>
                                <div class="team__content">
                                    <h3 class="team__content--title">Milton Marsh</h3>
                                    <span class="team__content--subtitle">Yönetici </span>
                                    <ul class="team__social d-flex justify-content-center align-items-center">
                                        <li class="team__social--list">
                                            <a class="team__social--icon" target="_blank" href="https://www.facebook.com/">
                                                <svg  xmlns="http://www.w3.org/2000/svg" width="7.667" height="16.524" viewBox="0 0 7.667 16.524">
